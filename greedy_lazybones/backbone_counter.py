...
def number_of_backbones(field, info):
    ...
    routers_coords = router_coordinates(field, info)
    b_cells = 1
...
def router_coordinates(field, info):
    routers_coords = []
...
if __name__ == "__main__":
    ...
    print(number_of_backbones(field_file, get_params(source_file)))
